...
<head>
    ...
    <title>Sign in</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('authAssets/images/circle-cropped.png') }}">
                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-2">
                                <div class="text-center">
                                     <img src="{{ asset('authAssets/images/circle-cropped.png') }} " style="width: 100px" />
                                </div>
                                <form class="mt-5 mb-5 login-input" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ old('email') }}"
                                        name="email"
                                        placeholder="{{ __('E-Mail') }}" required autocomplete="email" autofocus>
                                        @error('email')
