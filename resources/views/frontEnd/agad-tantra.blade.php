...
@section('title','Agad-Tantra & Vidhi Vaidyaka')
        ...
        <div class="col-md-9">
          <div class="row" >
            <div class="col-md-12 main-box">
              <h4 class="title-heading1 text-center">Agad Tantra and Vidhi Vaidyaka</h4><hr>
              <p class="text-center">
              <h5 class="text-center"><b>Agad Tantra</b></h5>
              <p class="text-center">The word gada means disease and the word agad means to get rid of disease. Agad also means specific preparations or antidotes for poisons. This branch deals.....</p>
              <h4 class="title-heading1">List of Equipments</h4>
              <ul class="list-none">
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/114nmhC8oW9YdeofIF3p8pVJMf8XsnerW/view" class="color" target="_blank">Charts</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1iUKd6J0OI6eiJ-ItLTgkKYMCoGRbMxav/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1c1un_a8lq7sB4iT5vz0z6mTIpdnkFnnD/view" class="color" target="_blank">Models & Specimen</a></li>
              </ul>
            </div>
          </div>
        </div>
