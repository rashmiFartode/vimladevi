            ...
            <!--col-md-3 closed -->
             <div class="col-md-9  main-box gallery-block grid-gallery">
              <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                 <h4 class="title-heading1 text-center">Sports</h4><hr>
                 </div>
                 ...
                 @endforeach
                    {{-- <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/3.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/3.jpeg') }}">
                        </a>
                    </div>

                    <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/5.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/5.jpeg') }}">
                        </a>
                    </div>
                    <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/6.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/6.jpeg') }}">
                        </a>
                    </div>
                   <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/7.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/7.jpeg') }}">
                        </a>
                    </div>
                     <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/8.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/8.jpeg') }}">
                        </a>
                    </div>
                     <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/9.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/9.jpeg') }}">
                        </a>
                    </div>
                     <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/10.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/10.jpeg') }}">
                        </a>
                    </div>
                    <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/11.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/11.jpeg') }}">
                        </a>
                    </div>
                    <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/12.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/12.jpeg') }}">
                        </a>
                    </div>
                    <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/13.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/13.jpeg') }}">
                        </a>
                    </div>

                    <div class="col-md-4 col-lg-4 item">
                        <a class="lightbox" href="{{ asset('frontAssets/images/icon/15.jpeg') }}">
                            <img class="img-fluid image scale-on-hover" src="{{ asset('frontAssets/images/icon/15.jpeg') }}">
                        </a>
                    </div> --}}
