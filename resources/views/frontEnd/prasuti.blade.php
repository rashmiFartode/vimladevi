...
@section('title','Prasuti & Stri Roga')
            ...
            <div class="col-md-9">
              <div class="row" >
                <div class="col-md-12 main-box">
                           <h4 class="title-heading1 text-center">Prasuti & Stri Roga</h4><hr>
                           <p class="text-center">
                                <p class="text-center">Prasuti and Strirog branch of Ayurveda mainly deals with ideal guidelines to be followed during pregnancy. The mother should be healthy as her health is directly related to the health of  the.....</p>
                            <h4 class="title-heading1">List of Equipments</h4>
                            <ul class="list-none text-left">
                              <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1UlbK40JtH8ZQa_9t_zubi4EHJ5e1XlAO/view" class="color" target="_blank">Charts</a></li>
                              <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1SjvYQjxaks3eR4xBZB8Ug8EFPRptxlTv/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                               <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1wRCSw9v9zrtaEuaCFV34x4co_m6GYqlS/view" class="color" target="_blank">Models</a></li>
