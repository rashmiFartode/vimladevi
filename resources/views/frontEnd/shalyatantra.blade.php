  ...
  <main id="main">
    ...
    <section>
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title-heading1 text-center mb-4"><b>Shalakya</b></h2>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-md-9">
              <div class="row" >
                <div class="col-md-12 main-box">
                          <h4 class="title-heading1 text-center">Shalyatantra + (Ksharsutra Lab.)</h4><hr>
                           <p class="text-center">
                                <p class="text-center">In the ancient India, surgery was principally pioneered by Ayurveda. Shalya Chikitsa is a significant branch of Ayurvedic science. The name of the sage-physician, Susruta, is synonymous with surgery. From his treatise Susruta Samhita, we have become aware of the thousand of years ago sophisticated.....</p>
                            <h4 class="title-heading1">List of Equipments</h4>
                            <ul class="list-none text-left">
                              <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1Ju0G6k__Uy8pUIlG4Nfrem5tCTS3VlnD/view" class="color"  target="_blank">Charts</a></li>
                              <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1YMAA9BeWRueMuSaOwwOR-Ikal38Ka0M1/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                              <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1H1Hq2IVTUbNaSmIPGRZLo6KcVMh80Sba/view" class="color" target="_blank">Models</a></li>
                               <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1LZElK69USuza-Df3ChE0ZapPwhtPqm65/view" class="color" target="_blank">Furniture</a></li>
                            </ul>
                         </div>
                        </div>
                      </div>
