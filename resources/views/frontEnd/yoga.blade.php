...
@section('title','Swasthavritta & Yoga')
@section('customcss')
<style type="text/css">
    ...
    ============================-->
      <section>
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title-heading1 text-center mb-4"><b>Department</b></h2>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="row" >
                        ...
                        <h4 class="title-heading1 text-center">Swasthavritta & Yoga</h4><hr>
                               <p class="text-center">
                                 Swasthavritta & Yoga department mainly focuses on maintaining health of a person by means of proper food eating habits and regimes accompanied by spiritual and mental growth of a person by practice if yoga and.....</p>
                                <h4 class="title-heading1">List of Equipments</h4>
                                <ul class="list-none text-left">
                                  <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1tgj44mIM3E8yWJSu4_jRo71BvWqT0PVQ/view" class="color" target="_blank">Charts</a></li>
                                  <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1DrVVuWE7_a7AcIykMDXKlx4ZSKISCVcY/view" class="color"  target="_blank">Essential Equipment & Instruments</a></li>
                                  <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1eTfmhqI5Vgu-vwslyEekEmpHEdJETLgo/view" class="color" target="_blank">Models</a></li><li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/15uJ_O-Afp_iLgzLrearuw1zNfGvYpy2d/view" target="_blank">Furniture</a></li>
                                </ul>
                         </div>
                        </div>
                      </div>
