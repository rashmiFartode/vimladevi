...
@section('title','Ayurved Samhita & Siddhant')
        ...
        <div class="col-md-9">
          <div class="row" >
            <div class="col-md-12 main-box">
              <h4 class="title-heading1 text-center">Ayurved Samhita & Siddhant</h4><hr>
              <h5 class="text-center"><b>THE GREAT THREE CLASSICS OF AYURVEDA</b></h5>
              <p class="text-center">The basic principles of Ayurved were in a  premature stage during the vedic period. The seers like Charak, Sushrut and Vagbhata created ayurvedic classics which clearly established the ayurvedic.....</p>
              <h4 class="title-heading1">List of Equipments</h4>
              <ul class="list-none text-left">
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1v710s3fBlhenN1HHlwljl4OblTVB29vd/view" class="color" target="_blank">Charts</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/18avkqdzDfQSJGB2E_wenRNRXtm1ZADsj/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1nIwR5h8VTH2FhzZFKrNsM2L91m1RUbtH/view" class="color" target="_blank">Models</a></li>
              </ul>
            </div>
          </div>
        </div>
