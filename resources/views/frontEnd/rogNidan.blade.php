...
@section('title','Rog Nidan & Vikriti Vigyan')
@section('customcss')
<style type="text/css">
  ...
  <main id="main">
    ...
    <section>
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title-heading1 text-center mb-4"><b>Rog Nidan</b></h2>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-md-9">
              <div class="row" >
                        ...
                        <div class="col-md-12 main-box">
                         <h4 class="title-heading1 text-center"> Rog Nidan & Vikriti Vigyan</h4><hr>
                               <p class="text-center">
                                  This department mainly deals with diagnosis of disease by Ayurvedic methodology along with modern pathological concepts.....</p>
                                <h4 class="title-heading1">List of Equipments</h4>
                                <ul class="list-none text-left">
                                  <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1RDIt6b0UPDcGCptWuxmxh-cSMFulwlzW/view" class="color" target="_blank">Charts</a></li>
                                  <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/140vJuDWg-TYOxMZuV9oodR9xeHFfzLwn/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                                  <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1ofbGCzi5y7bsrTmpOycG5J7iD0Z3g-FA/view" class="color" target="_blank">Models & Specimen</a></li>
                                </ul>
                         </div>
                        </div>
                      </div>
