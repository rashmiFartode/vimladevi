...
@section('title','Dravyaguna Vigyana')
        ...
        <div class="col-md-9">
          <div class="row" >
            <div class="col-md-12 main-box">
              <h4 class="title-heading1 text-center">Dravyaguna Vigyana</h4><hr>
              <p class="text-center">This department deals with the study of herbal plants including pharmacognosy, pharmacology and therapeutic uses of the plants. Ayurvedic drugs, especially herbs are prescribed in different pharmaceutical forms, to get maximum therapeutic.....</p>
              <h4 class="title-heading1">List of Equipments</h4>
              <ul class="list-none text-left">
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/16PYzgrBmzGzX2P63Yz6KKCCaiIfUaG6f/view" class="color" target="_blank">Charts</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/15_GKvMpLwcptf8akUrpUzbBnD0EiX65x/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1aUlw6tRocKzp7gB9RvBvB2G3XvkjKLy5/view" class="color" target="_blank">Furniture</a></li>
              </ul>
            </div>
          </div>
        </div>
