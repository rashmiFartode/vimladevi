            ...
            <div class="col-md-9">
              <div class="row" >
                <div class="col-md-12 main-box">
                           <h4 class="title-heading1 text-center">Shalakya Tantra</h4><hr>
                           <p class="text-center">
                                <p class="text-center">Shalakya is the branch of Ayurveda dealing with causes, pathology, symptoms, complications and treatment of diseases of organs above clavide or collar bone and hence also known by the name urdhwanga.....</p>
                            <h4 class="title-heading1">List of Equipments</h4>
                            <ul class="list-none text-left">
                              <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1CT9A9dtj30D1vCx3yh-VZvGqhw7MLmIb/view" class="color" target="_blank">Charts</a>&nbsp;</li>
                              <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1EYDB7DdBiMXAZabBw0jh7eCGGORt4frr/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                            </ul>
                         </div>
                        </div>
                      </div>
