    ...
    ============================-->
      <section>
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title-heading1 text-center mb-4"><b>Recent Activity</b></h2>
            </div>
          </div>
        </div>
      </section>
                    ...
                    <div class="tab-pane fade show active" id="list-agro" role="tabpanel" aria-labelledby="list-agro-list">
                      <div class="row ">
                        <div class="col-md-12 main-box">
                            <img src='{{ asset('storage/'.$recent_activity->file) }}' class='img-fluid' style='height: 300px; width:100%'>
                            <h4 class="title-heading1 text-center">{{ $recent_activity->title }}</h4>
