<!-- Favicons -->
<link href="{{ asset('frontAssets/img/vimladeviCollege/vimladevi_logo.png') }}" rel="icon">
  ...
  <link href="{{ asset('frontAssets/lib/magnific-popup/magnific-popup.css') }}" rel="stylesheet">
  <link href="{{ asset('frontAssets/lib/ionicons/css/ionicons.min.css') }}" rel="stylesheet">

  <!-- Main Stylesheet File -->
  <link href="{{ asset('frontAssets/css/mystyle.css') }}" rel="stylesheet">
