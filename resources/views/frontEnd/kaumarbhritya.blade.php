...
@section('title','Kaumarbhritya-Bala Rog')
        ...
        <div class="col-md-9">
          <div class="row" >
            <div class="col-md-12 main-box">
              <h4 class="title-heading1 text-center">Kaumarbhritya - Bala Rog</h4><hr>
              <p class="text-center">
              <p class="text-center">Kumar means period of life from conception to the age of 16 years and Bhritya means servant. However this branch deals with prenatal and post natal baby care along with the care of the mother before conception.....</p>
              <h4 class="title-heading1">List of Equipments</h4>
              <ul class="list-none text-left">
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1v3ezFCzvf0bbWCB_VdEs0BznTDVcW3QZ/view" class="color" target="_blank">Charts</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1fNY6fwnEDXXcHKEtjr2IhEs0oPMiuKL3/view" class="color" target="_blank">Essential Equipment & Instruments</a></li>
                <li><i class="fa fa-hand-o-right"></i>&nbsp;<a href="https://drive.google.com/file/d/1LxRHddVBXBhxOpXnpZ5U9KnyoJWN4_u-/view" class="color" target="_blank">Furniture</a></li>
              </ul>
            </div>
          </div>
        </div>
